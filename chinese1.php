...
function updateItem($conn, $itemName, $quantity, $amount) {
    ...
    if ($conn->query($sql) === TRUE) {
        echo "<script>alert('added to cart');
                window.location.href='chinese.php';</script>";
    } else {
...
if(isset($_POST['btn1'])) {
    ...
    $sql = "SELECT id,name, amount FROM itemlist where id=117";
    $result = $conn->query($sql);
    $row = $result->fetch_assoc();
    $id1=$row["id"];    //here
    $name1 = $row["name"];
...
if(isset($_POST['btn2'])) {
    ...
    $sql = "SELECT id,name, amount FROM itemlist where id=118";
    $result = $conn->query($sql);
    $row = $result->fetch_assoc();
    $id2=$row["id"];
    $name2 = $row["name"];
...
if(isset($_POST['btn3'])) {
    ...
    $sql = "SELECT id,name, amount FROM itemlist where id=119";
    $result = $conn->query($sql);
    $row = $result->fetch_assoc();
    $id3=$row["id"];
    $name3 = $row["name"];
...
if(isset($_POST['btn4'])) {
    ...
    $sql = "SELECT id,name, amount FROM itemlist where id=120";
    $result = $conn->query($sql);
    $row = $result->fetch_assoc();
    $id4=$row["id"];
    $name4 = $row["name"];
...
if(isset($_POST['btn5'])) {
    ...
    $sql = "SELECT id,name, amount FROM itemlist where id=121";
    $result = $conn->query($sql);
    $row = $result->fetch_assoc();
    $id5=$row["id"];
    $name5 = $row["name"];
...
if(isset($_POST['btn6'])) {
    ...
    $sql = "SELECT id,name, amount FROM itemlist where id=122";
    $result = $conn->query($sql);
    $row = $result->fetch_assoc();
    $id6=$row["id"];
    $name6 = $row["name"];
...
if(isset($_POST['btn7'])) {
    ...
    $sql = "SELECT id,name, amount FROM itemlist where id=123";
    $result = $conn->query($sql);
    $row = $result->fetch_assoc();
    $id7=$row["id"];
    $name7 = $row["name"];
...
if(isset($_POST['btn8'])) {
    ...
    $sql = "SELECT id,name, amount FROM itemlist where id=124";
    $result = $conn->query($sql);
    $row = $result->fetch_assoc();
    $id8=$row["id"];
    $name8 = $row["name"];
